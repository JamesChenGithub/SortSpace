...
- (bool)doInit
{
    ...
    _viewScale = self.contentScaleFactor;
...
-(void)layoutSubviews{
        ...
        //把数据显示在这个视窗上
        glViewport(1, 1, self.bounds.size.width*_viewScale, self.bounds.size.height*_viewScale );
...
-(void)render{
    ...
    //把数据显示在这个视窗上
    glViewport(1, 1, size.width * _viewScale, size.height * _viewScale);
